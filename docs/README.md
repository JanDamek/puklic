...
Single source of truth for architecture and the domain model. Every architectural / domain change must update at least one file here in the same commit as the code.

## Map

| Section | Contents |
|---|---|
| [`00_overview/`](00_overview/) | Product vision, glossary |
| [`01_architecture/`](01_architecture/) | ADR, module map, data flow, threading model |
| [`02_domain/`](02_domain/) | Chat model, RichText AST, Discord protocol |
| [`03_infrastructure/`](03_infrastructure/) | Persistence schema, cache policy, platform abstractions, architect-reports/ |
| [`04_ui/`](04_ui/) | Design system, screen inventory, component library |
| [`05_platforms/`](05_platforms/) | Linux/Wayland, Android, iOS specifics |
| [`06_ops/`](06_ops/) | Build, CI, release |
| [`07_roadmap/`](07_roadmap/) | Phases 1–5 |

## Quick links

- [Product vision](00_overview/product-vision.md)
...
- [Chat domain model](02_domain/chat-model.md)
- [RichText AST + parser](02_domain/richtext-ast.md)
- [Discord protocol](02_domain/discord-protocol.md)
...
- [Linux/Wayland specifics](05_platforms/linux-wayland.md)
- [Android specifics](05_platforms/android.md)
- [iOS specifics](05_platforms/ios.md)
